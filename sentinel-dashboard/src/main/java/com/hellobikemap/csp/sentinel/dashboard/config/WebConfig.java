 ...
 */
package com.hellobikemap.csp.sentinel.dashboard.config;

import java.util.Arrays;
import java.util.HashSet;
import java.util.Set;

import com.hellobikemap.csp.sentinel.adapter.servlet.CommonFilter;
import com.hellobikemap.csp.sentinel.adapter.servlet.callback.WebCallbackManager;
import com.hellobikemap.csp.sentinel.dashboard.auth.AuthorizationInterceptor;
import com.hellobikemap.csp.sentinel.dashboard.auth.LoginAuthenticationFilter;
