 ...
 */
package com.hellobikemap.csp.sentinel.adapter.reactor;
...
public class SentinelReactorSubscriber<T> extends InheritableBaseSubscriber<T> {
    ...
    public Context currentContext() {
        ...
        com.hellobikemap.csp.sentinel.context.Context sentinelContext = currentEntry.getAsyncContext();
    ...
    private void doWithContextOrCurrent(Supplier<Optional<com.hellobikemap.csp.sentinel.context.Context>> contextSupplier,
                                        Runnable f) {
        Optional<com.hellobikemap.csp.sentinel.context.Context> contextOpt = contextSupplier.get();
