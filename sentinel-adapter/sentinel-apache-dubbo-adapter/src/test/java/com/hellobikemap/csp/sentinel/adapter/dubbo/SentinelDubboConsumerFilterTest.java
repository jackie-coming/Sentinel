...
import com.hellobikemap.csp.sentinel.BaseTest;
import com.hellobikemap.csp.sentinel.DubboTestUtil;
import com.hellobikemap.csp.sentinel.Entry;
...
import com.hellobikemap.csp.sentinel.adapter.dubbo.fallback.DubboFallback;
import com.hellobikemap.csp.sentinel.adapter.dubbo.fallback.DubboFallbackRegistry;
import com.hellobikemap.csp.sentinel.context.Context;
import com.hellobikemap.csp.sentinel.context.ContextUtil;
import com.hellobikemap.csp.sentinel.node.ClusterNode;
import com.hellobikemap.csp.sentinel.node.DefaultNode;
import com.hellobikemap.csp.sentinel.node.Node;
import com.hellobikemap.csp.sentinel.node.StatisticNode;
...
import com.hellobikemap.csp.sentinel.slots.block.RuleConstant;
import com.hellobikemap.csp.sentinel.slots.block.degrade.DegradeRule;
import com.hellobikemap.csp.sentinel.slots.block.degrade.DegradeRuleManager;
...
import static com.hellobikemap.csp.sentinel.slots.block.RuleConstant.DEGRADE_GRADE_EXCEPTION_RATIO;
...
public class SentinelDubboConsumerFilterTest extends BaseTest {
    ...
    private void verifyInvocationStructure(Invoker invoker, Invocation invocation) {
        ...
        assertEquals(com.hellobikemap.csp.sentinel.Constants.CONTEXT_DEFAULT_NAME, context.getName());
        assertEquals("", context.getOrigin());

        DefaultNode entranceNode = context.getEntranceNode();
        ResourceWrapper entranceResource = entranceNode.getId();

        assertEquals(com.hellobikemap.csp.sentinel.Constants.CONTEXT_DEFAULT_NAME, entranceResource.getName());
