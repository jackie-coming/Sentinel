 ...
 */
package com.hellobikemap.csp.sentinel.adapter.dubbo;

import com.hellobikemap.csp.sentinel.adapter.dubbo.config.DubboAdapterGlobalConfig;
import com.hellobikemap.csp.sentinel.adapter.dubbo.provider.DemoService;
...
import static com.hellobikemap.csp.sentinel.adapter.dubbo.config.DubboAdapterGlobalConfig.DUBBO_INTERFACE_GROUP_VERSION_ENABLED;
...
public class DubboUtilsTest {
    ...
    public void testGetResourceName() throws NoSuchMethodException {
        ...
        assertEquals("com.hellobikemap.csp.sentinel.adapter.dubbo.provider.DemoService:sayHello(java.lang.String,int)", resourceName);
    ...
    public void testGetResourceNameWithGroupAndVersion() throws NoSuchMethodException {
        ...
        assertEquals("com.hellobikemap.csp.sentinel.adapter.dubbo.provider.DemoService:1.0.0:grp1:sayHello(java.lang.String,int)", resourceNameUseGroupAndVersion);
    }
    ...
    public void testGetResourceNameWithPrefix() throws NoSuchMethodException {
        ...
        assertEquals("dubbo:provider:com.hellobikemap.csp.sentinel.adapter.dubbo.provider.DemoService:sayHello(java.lang.String,int)", resourceName);
        ...
        assertEquals("dubbo:consumer:com.hellobikemap.csp.sentinel.adapter.dubbo.provider.DemoService:sayHello(java.lang.String,int)", resourceName);
        ...
        assertEquals("my:dubbo:provider:com.hellobikemap.csp.sentinel.adapter.dubbo.provider.DemoService:sayHello(java.lang.String,int)", resourceName);
        resourceName = DubboUtils.getMethodResourceName(invoker, invocation, DubboAdapterGlobalConfig.getDubboConsumerResNamePrefixKey());
        assertEquals("my:dubbo:consumer:com.hellobikemap.csp.sentinel.adapter.dubbo.provider.DemoService:sayHello(java.lang.String,int)", resourceName);
    ...
    public void testGetInterfaceName() {
        ...
        SentinelConfig.setConfig(DUBBO_INTERFACE_GROUP_VERSION_ENABLED, "false");
        assertEquals("com.hellobikemap.csp.sentinel.adapter.dubbo.provider.DemoService", DubboUtils.getInterfaceName(invoker));
    ...
    public void testGetInterfaceNameWithGroupAndVersion() throws NoSuchMethodException {
        ...
        assertEquals("com.hellobikemap.csp.sentinel.adapter.dubbo.provider.DemoService:1.0.0:grp1", DubboUtils.getInterfaceName(invoker, true));
    }
    ...
    public void testGetInterfaceNameWithPrefix() throws NoSuchMethodException {
        ...
        assertEquals("dubbo:provider:com.hellobikemap.csp.sentinel.adapter.dubbo.provider.DemoService", resourceName);
        resourceName = DubboUtils.getInterfaceName(invoker, DubboAdapterGlobalConfig.getDubboConsumerResNamePrefixKey());
        assertEquals("dubbo:consumer:com.hellobikemap.csp.sentinel.adapter.dubbo.provider.DemoService", resourceName);
        ...
        assertEquals("my:dubbo:provider:com.hellobikemap.csp.sentinel.adapter.dubbo.provider.DemoService", resourceName);
        resourceName = DubboUtils.getInterfaceName(invoker, DubboAdapterGlobalConfig.getDubboConsumerResNamePrefixKey());
        assertEquals("my:dubbo:consumer:com.hellobikemap.csp.sentinel.adapter.dubbo.provider.DemoService", resourceName);
