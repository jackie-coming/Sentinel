 ...
 */
package com.hellobikemap.csp.sentinel.adapter.gateway.common.api.matcher;
...
public abstract class AbstractApiMatcher<T> implements Predicate<T> {
    ...
    /**
     * We use {@link com.hellobikemap.csp.sentinel.util.function.Predicate} here as the min JDK version is 1.7.
     */
