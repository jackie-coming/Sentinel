...
public class SentinelSofaRpcConsumerFilterTest extends BaseTest {
    ...
    public void testInvokeSentinelWorks() {
        ...
        final String interfaceResourceName = "com.hellobikemap.csp.sentinel.adapter.sofa.rpc.service.DemoService";
        final String methodResourceName = "com.hellobikemap.csp.sentinel.adapter.sofa.rpc.service.DemoService#sayHello(java.lang.String,int)";
