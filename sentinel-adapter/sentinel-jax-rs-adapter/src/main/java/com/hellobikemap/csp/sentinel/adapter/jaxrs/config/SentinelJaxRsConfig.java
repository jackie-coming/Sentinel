 ...
 */
package com.hellobikemap.csp.sentinel.adapter.jaxrs.config;

import com.hellobikemap.csp.sentinel.adapter.jaxrs.fallback.DefaultSentinelJaxRsFallback;
import com.hellobikemap.csp.sentinel.adapter.jaxrs.fallback.SentinelJaxRsFallback;
import com.hellobikemap.csp.sentinel.adapter.jaxrs.request.DefaultRequestOriginParser;
import com.hellobikemap.csp.sentinel.adapter.jaxrs.request.DefaultResourceNameParser;
import com.hellobikemap.csp.sentinel.adapter.jaxrs.request.RequestOriginParser;
import com.hellobikemap.csp.sentinel.adapter.jaxrs.request.ResourceNameParser;
