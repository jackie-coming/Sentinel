...
import com.hellobikemap.csp.sentinel.cluster.ClusterConstants;
import com.hellobikemap.csp.sentinel.cluster.ClusterErrorMessages;
import com.hellobikemap.csp.sentinel.cluster.ClusterMetadataKeys;
import com.hellobikemap.csp.sentinel.cluster.ClusterTransportClient;
import com.hellobikemap.csp.sentinel.cluster.TokenResult;
import com.hellobikemap.csp.sentinel.cluster.TokenResultStatus;
import com.hellobikemap.csp.sentinel.cluster.TokenServerDescriptor;
import com.hellobikemap.csp.sentinel.cluster.client.config.ClusterClientAssignConfig;
import com.hellobikemap.csp.sentinel.cluster.client.config.ClusterClientMultiServerConfig;
import com.hellobikemap.csp.sentinel.cluster.client.config.ClusterClientMultiServerConfig.ServerNode;
import com.hellobikemap.csp.sentinel.cluster.client.config.ClusterClientMultiServerConfigManager;
import com.hellobikemap.csp.sentinel.cluster.client.loadbalance.LoadBalanceStrategy;
import com.hellobikemap.csp.sentinel.cluster.client.loadbalance.LoadBalanceStrategyFactory;
import com.hellobikemap.csp.sentinel.cluster.client.loadbalance.LoadBalanceStrategyType;
import com.hellobikemap.csp.sentinel.cluster.log.ClusterClientStatLogUtil;
import com.hellobikemap.csp.sentinel.cluster.request.ClusterRequest;
import com.hellobikemap.csp.sentinel.cluster.request.data.FlowRequestData;
import com.hellobikemap.csp.sentinel.cluster.request.data.ParamFlowRequestData;
import com.hellobikemap.csp.sentinel.cluster.response.ClusterResponse;
import com.hellobikemap.csp.sentinel.cluster.response.data.FlowTokenResponseData;
import com.hellobikemap.csp.sentinel.log.RecordLog;
...
public class MultiServerClusterTokenClient implements ClusterTokenClient {
  ...
  private ServerNode selectHealthyServer(Long ruleId) {
    ...
    if (ruleId != null) {
      if (loadBalanceStrategy instanceof com.hellobikemap.csp.sentinel.cluster.client.loadbalance.ConsistentHashLoadBalanceStrategy) {
        return ((com.hellobikemap.csp.sentinel.cluster.client.loadbalance.ConsistentHashLoadBalanceStrategy) loadBalanceStrategy)
