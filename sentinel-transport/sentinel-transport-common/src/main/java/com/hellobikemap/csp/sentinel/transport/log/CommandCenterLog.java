 ...
 */
package com.hellobikemap.csp.sentinel.transport.log;

import com.hellobikemap.csp.sentinel.log.LoggerSpiProvider;
import com.hellobikemap.csp.sentinel.log.jul.JavaLoggingAdapter;
...
public class CommandCenterLog {
    ...
    private static com.hellobikemap.csp.sentinel.log.Logger logger = null;
