...
```
✅ sentinel-core-1.8.6.map.5.SNAPSHOT.jar (309 KB)
✅ sentinel-cluster-client-default-1.8.6.map.5.SNAPSHOT.jar (77 KB)
✅ sentinel-cluster-common-default-1.8.6.map.5.SNAPSHOT.jar
✅ sentinel-cluster-server-default-1.8.6.map.5.SNAPSHOT.jar
✅ sentinel-cluster-server-envoy-rls-1.8.6.map.5.SNAPSHOT.jar
```
...
- ✅ Maven 本地仓库已安装
- ✅ JAR 文件可用于集成测试
- ✅ 所有模块版本号一致 (1.8.6.map.5.SNAPSHOT)
...
```
~/.m2/repository/com/alibaba/csp/sentinel-core/1.8.6.map.5.SNAPSHOT/
  ├── sentinel-core-1.8.6.map.5.SNAPSHOT.jar
  ├── sentinel-core-1.8.6.map.5.SNAPSHOT.pom
  ├── sentinel-core-1.8.6.map.5.SNAPSHOT-sources.jar
  └── sentinel-core-1.8.6.map.5.SNAPSHOT-javadoc.jar

~/.m2/repository/com/alibaba/csp/sentinel-cluster-client-default/1.8.6.map.5.SNAPSHOT/
  ├── sentinel-cluster-client-default-1.8.6.map.5.SNAPSHOT.jar
  ├── sentinel-cluster-client-default-1.8.6.map.5.SNAPSHOT.pom
  ├── sentinel-cluster-client-default-1.8.6.map.5.SNAPSHOT-sources.jar
  └── sentinel-cluster-client-default-1.8.6.map.5.SNAPSHOT-javadoc.jar
```
