...
public class AuthValidatorTest {
  ...
  public void testValidate() {
    ...
    AuthRule okAuthRule = new AuthRule(
        new AuthCondition(AuthType.DESTINATION_PORT, new PortMatcher(8080)));
    AuthRule notAuthRule = new AuthRule(
        new AuthCondition(AuthType.DESTINATION_PORT, new PortMatcher(8081)));
  ...
  public void testValidateRule() {
    ...
    AuthRule authRuleChild1 = new AuthRule(
        new AuthCondition(AuthType.DESTINATION_PORT, new PortMatcher(8080)));
    AuthRule authRuleChild2 = new AuthRule(
        new AuthCondition(AuthType.DESTINATION_PORT, new PortMatcher(8081)));
  ...
  public void testValidateLeafRule() {
    ...
    AuthRule authRuleTrue = new AuthRule(
        new AuthCondition(AuthType.DESTINATION_IP, new IpMatcher(32, "11.1.1.1")));
    ...
    authRuleTrue = new AuthRule(
        new AuthCondition(AuthType.REMOTE_IP, new IpMatcher(32, "12.1.1.1")));
    authRuleFalse = new AuthRule(
        new AuthCondition(AuthType.REMOTE_IP, new IpMatcher(32, "12.1.1.0")));
    Assert.assertTrue(AuthValidator.validateLeafRule(authRuleTrue, request));
    Assert.assertFalse(AuthValidator.validateLeafRule(authRuleFalse, request));

    authRuleTrue = new AuthRule(
        new AuthCondition(AuthType.DIRECT_REMOTE_IP, new IpMatcher(32, "13.1.1.1")));
    authRuleFalse = new AuthRule(
        new AuthCondition(AuthType.DIRECT_REMOTE_IP, new IpMatcher(32, "13.1.1.0")));
    Assert.assertTrue(AuthValidator.validateLeafRule(authRuleTrue, request));
    Assert.assertFalse(AuthValidator.validateLeafRule(authRuleFalse, request));
    ...
    authRuleTrue = new AuthRule(
        new AuthCondition(AuthType.METHODS,
            new StringMatcher("put", StringMatcher.MatcherType.EXACT, false)));
    authRuleFalse = new AuthRule(
        new AuthCondition(AuthType.METHODS,
            new StringMatcher("get", StringMatcher.MatcherType.EXACT, false)));
    Assert.assertTrue(AuthValidator.validateLeafRule(authRuleTrue, request));
    Assert.assertFalse(AuthValidator.validateLeafRule(authRuleFalse, request));
    ...
    authRuleFalse = new AuthRule(
        new AuthCondition(AuthType.HEADER, "abcd",
            new StringMatcher("a", StringMatcher.MatcherType.EXACT, false)));
    authRuleFalse1 = new AuthRule(new AuthCondition(AuthType.JWT_CLAIMS, "abcd",
        new StringMatcher("a", StringMatcher.MatcherType.EXACT, false)));
    Assert.assertFalse(AuthValidator.validateLeafRule(authRuleFalse, request));
