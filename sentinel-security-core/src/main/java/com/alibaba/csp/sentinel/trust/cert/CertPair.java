...
public class CertPair {
  ...
  public boolean equals(Object o) {
    ...
    return expireTime == certPair.expireTime && Arrays.equals(certificateChain,
        certPair.certificateChain)
        && Objects.equals(privateKey, certPair.privateKey) && Arrays.equals(rawCertificateChain,
        certPair.rawCertificateChain) && Arrays.equals(rawPrivateKey, certPair.rawPrivateKey)
        && Objects.equals(
