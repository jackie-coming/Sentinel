...
import com.hellobikemap.csp.sentinel.slotchain.*;
...
import com.hellobikemap.csp.sentinel.spi.SpiLoader;
...
public class DemoSlotChainBuilder implements SlotChainBuilder {
     ...
     * Note that the sentinel's default slots and the order of them are very important, be careful when customizing,
     * refer to the constants for slot order definitions in {@link com.hellobikemap.csp.sentinel.Constants}.
     */
    /*
    @Override
    public ProcessorSlotChain build() {
        ...
        chain.addLast((AbstractLinkedProcessorSlot<?>) spiLoader.loadInstance("com.hellobikemap.csp.sentinel.slots.clusterbuilder.ClusterBuilderSlot"));
