 ...
 */
package com.hellobikemap.csp.sentinel.demo.spring.webmvc.config;

import com.hellobikemap.csp.sentinel.adapter.spring.webmvc.SentinelWebInterceptor;
import com.hellobikemap.csp.sentinel.adapter.spring.webmvc.SentinelWebTotalInterceptor;
import com.hellobikemap.csp.sentinel.adapter.spring.webmvc.callback.DefaultBlockExceptionHandler;
import com.hellobikemap.csp.sentinel.adapter.spring.webmvc.config.SentinelWebMvcConfig;
import com.hellobikemap.csp.sentinel.adapter.spring.webmvc.config.SentinelWebMvcTotalConfig;
