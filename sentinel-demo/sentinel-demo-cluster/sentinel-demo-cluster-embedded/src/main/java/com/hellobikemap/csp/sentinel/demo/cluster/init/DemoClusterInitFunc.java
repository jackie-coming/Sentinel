 ...
 */
package com.hellobikemap.csp.sentinel.demo.cluster.init;

import java.util.List;
import java.util.Objects;
import java.util.Optional;

import com.hellobikemap.csp.sentinel.cluster.ClusterStateManager;
import com.hellobikemap.csp.sentinel.cluster.client.config.ClusterClientAssignConfig;
import com.hellobikemap.csp.sentinel.cluster.client.config.ClusterClientConfig;
import com.hellobikemap.csp.sentinel.cluster.client.config.ClusterClientConfigManager;
import com.hellobikemap.csp.sentinel.cluster.flow.rule.ClusterFlowRuleManager;
import com.hellobikemap.csp.sentinel.cluster.flow.rule.ClusterParamFlowRuleManager;
import com.hellobikemap.csp.sentinel.cluster.server.config.ClusterServerConfigManager;
import com.hellobikemap.csp.sentinel.cluster.server.config.ServerTransportConfig;
import com.hellobikemap.csp.sentinel.datasource.ReadableDataSource;
import com.hellobikemap.csp.sentinel.datasource.nacos.NacosDataSource;
import com.hellobikemap.csp.sentinel.demo.cluster.DemoConstants;
import com.hellobikemap.csp.sentinel.demo.cluster.entity.ClusterGroupEntity;
import com.hellobikemap.csp.sentinel.init.InitFunc;
import com.hellobikemap.csp.sentinel.slots.block.flow.FlowRule;
import com.hellobikemap.csp.sentinel.slots.block.flow.FlowRuleManager;
import com.hellobikemap.csp.sentinel.slots.block.flow.param.ParamFlowRule;
import com.hellobikemap.csp.sentinel.slots.block.flow.param.ParamFlowRuleManager;
import com.hellobikemap.csp.sentinel.transport.config.TransportConfig;
import com.hellobikemap.csp.sentinel.util.AppNameUtil;
import com.hellobikemap.csp.sentinel.util.HostNameUtil;
