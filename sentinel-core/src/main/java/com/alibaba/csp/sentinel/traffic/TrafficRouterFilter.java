...
public class TrafficRouterFilter implements RouterFilter {
  ...
  @Override
  public List<Instance> filter(List<Instance> instanceList, TrafficContext context)
  ...
  protected String randomSelectDestination(String appName, List<RouteDestination> routeDestination,
      List<Instance> instanceList) throws TrafficException {
  ...
  protected String computeDestination(String appName, Destination destination,
      List<Instance> instanceList) throws TrafficException {
  ...
  //todo 地址通知时缓存优化
  private List<Instance> getSubsetInstances(String appName, String subset,
  ...
  protected List<RouteDestination> getRouteDestination(
      TrafficRoutingRuleGroup trafficRoutingRuleGroup, TrafficContext context) {
