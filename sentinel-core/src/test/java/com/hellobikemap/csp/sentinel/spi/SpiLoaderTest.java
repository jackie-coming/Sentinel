...
import com.hellobikemap.csp.sentinel.metric.extension.MetricCallbackInit;
import com.hellobikemap.csp.sentinel.slotchain.ProcessorSlot;
import com.hellobikemap.csp.sentinel.slotchain.SlotChainBuilder;
import com.hellobikemap.csp.sentinel.slots.DefaultSlotChainBuilder;
import com.hellobikemap.csp.sentinel.slots.block.authority.AuthoritySlot;
import com.hellobikemap.csp.sentinel.slots.block.degrade.DegradeSlot;
import com.hellobikemap.csp.sentinel.slots.block.flow.FlowSlot;
import com.hellobikemap.csp.sentinel.slots.clusterbuilder.ClusterBuilderSlot;
import com.hellobikemap.csp.sentinel.slots.logger.LogSlot;
import com.hellobikemap.csp.sentinel.slots.nodeselector.NodeSelectorSlot;
import com.hellobikemap.csp.sentinel.slots.statistic.StatisticSlot;
import com.hellobikemap.csp.sentinel.slots.system.SystemSlot;
...
public class SpiLoaderTest {
    ...
    public void testLoadInstanceByAliasName() {
        ProcessorSlot slot = SpiLoader.of(ProcessorSlot.class).loadInstance("com.hellobikemap.csp.sentinel.slots.statistic.StatisticSlot");
        assertNotNull(slot);
        assertTrue(slot instanceof StatisticSlot);
    }
    ...
    public void testToString() {
        SpiLoader spiLoader = SpiLoader.of(ProcessorSlot.class);
        assertEquals("com.hellobikemap.csp.sentinel.spi.SpiLoader[com.hellobikemap.csp.sentinel.slotchain.ProcessorSlot]"
                , spiLoader.toString());
    }
