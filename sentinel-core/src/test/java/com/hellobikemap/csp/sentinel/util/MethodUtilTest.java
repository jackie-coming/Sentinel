...
public class MethodUtilTest {
    ...
    public void testResolveMethodName() {
        ...
        assertEquals("com.hellobikemap.csp.sentinel.util.MethodUtilTest$GoodClass:foo(long[],java.lang.String,java.lang.Integer[])",
        ...
        assertEquals("com.hellobikemap.csp.sentinel.util.MethodUtilTest$GoodClass:baz(double)",
