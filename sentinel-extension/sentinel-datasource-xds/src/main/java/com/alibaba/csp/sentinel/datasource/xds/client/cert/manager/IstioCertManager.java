...
public class IstioCertManager extends AbstractCertManager {
  ...
  public IstioCertManager(XdsConfigProperties xdsConfigProperties,
      CertPairRepository certPairRepository) {
    super(xdsConfigProperties, certPairRepository);
  }

  public static String getCSR(KeyPair localKeyPair, AsymCryptoType asymCryptoType,
      HashType hashType) {
    try {
  ...
  protected CertPair doGetNewCertPair() {
    ...
    try {
      ...
      newCertPair.setRawPrivateKey(
          CertificateUtil.getRawPrivateKey(localKeyPair.getPrivate(),
              xdsConfigProperties.getAsymCryptoType()));
      ...
      Metadata header = createHeader(xdsConfigProperties.getIstiodToken(),
      ...
      long certExpireTime =
          System.currentTimeMillis() + xdsConfigProperties.getCertValidityTimeS() * 1000;
      stub.createCertificate(
          ...
          new StreamObserver<IstioCertificateResponse>() {
            ...
            public void onNext(
              ...
              newCertPair.setRawCertificateChain(
                  certChainRaw.toString().getBytes(StandardCharsets.UTF_8));
              newCertPair.setCertificateChain(
