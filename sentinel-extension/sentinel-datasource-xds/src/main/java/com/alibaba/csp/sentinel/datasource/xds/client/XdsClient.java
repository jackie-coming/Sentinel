...
public class XdsClient {
  ...
  public void start() {
    if (running.compareAndSet(false, true)) {
      ...
      for (XdsFilter xdsFilter : this.xdsFilters) {
        ...
        if (protocol == null) {
          RecordLog.error("[XdsDataSource] Unsupported xdsFilter,xdsType={}",
              xdsFilter.getXdsTypeUrl());
        } else {
  ...
  private class XdsDiscoveryResponseObserver implements StreamObserver<DiscoveryResponse> {
    ...
    public void onNext(DiscoveryResponse discoveryResponse) {
      ...
      RecordLog.info("[XdsDataSource] Receive notification from xds server, type: {}, size: {}",
          typeUrl,
