...
/**
 * Certificate management class, used to get certificates and certificates rotation
 *
 * @author lwj
 * @since 2.0.0
 */
public abstract class AbstractCertManager implements AutoCloseable {
  ...
  /**
   * Obtain a new certificate and enable the task of obtaining a new certificate after
