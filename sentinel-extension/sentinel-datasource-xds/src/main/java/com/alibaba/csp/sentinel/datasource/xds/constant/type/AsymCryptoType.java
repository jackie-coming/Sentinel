...
/**
 * Types of asymmetric cryptographic algorithms, If the primary type is RSA, the subtype is prime
 * length; if the primary type is ECDSA, the subtype is ellipse type
 *
 * @author lwj
 * @since 2.0.0
 */
