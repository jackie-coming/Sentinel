...
public class TlsModeLdsFilterTest {
  ...
  /**
   * TlsModeLdsFilterTest1.ser  file contains yaml ./resources/yaml/TlsModeLdsFilterTest1.yaml
   */
  ...
  /**
   * TlsModeLdsFilterTest2.ser  file contains yaml ./resources/yaml/TlsModeLdsFilterTest2.yaml
   *
   * @throws IOException
  ...
  /**
   * TlsModeLdsFilterTest3.ser  file contains yaml ./resources/yaml/TlsModeLdsFilterTest3.yaml
   *
   * @throws IOException
   * @throws URISyntaxException
   * @throws ClassNotFoundException
  ...
  public TlsMode getFromFile(String fileName)
