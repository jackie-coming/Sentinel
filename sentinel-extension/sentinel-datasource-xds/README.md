...
This data now only provides access to zero-trust underlying data (certificates and authentication
rules).
...
- `parser`: The parser doesn't really work because the XdsDataSource relies on a registration to
  pass data
