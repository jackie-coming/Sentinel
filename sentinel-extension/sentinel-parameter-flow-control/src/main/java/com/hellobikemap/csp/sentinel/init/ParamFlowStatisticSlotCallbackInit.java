 ...
 */
package com.hellobikemap.csp.sentinel.init;

import com.hellobikemap.csp.sentinel.slots.statistic.ParamFlowStatisticEntryCallback;
import com.hellobikemap.csp.sentinel.slots.statistic.ParamFlowStatisticExitCallback;
import com.hellobikemap.csp.sentinel.slots.statistic.StatisticSlotCallbackRegistry;

/**
 * Init function for adding callbacks to {@link StatisticSlotCallbackRegistry} to record metrics
 * for frequent parameters in {@link com.hellobikemap.csp.sentinel.slots.statistic.StatisticSlot}.
 *
 * @author Eric Zhao
 * @since 0.2.0
 */
