 ...
 */
package com.hellobikemap.csp.sentinel.annotation.aspectj.integration;

import com.hellobikemap.csp.sentinel.annotation.aspectj.integration.config.AopTestConfig;
import com.hellobikemap.csp.sentinel.annotation.aspectj.integration.service.BarService;
import com.hellobikemap.csp.sentinel.annotation.aspectj.integration.service.FooService;
import com.hellobikemap.csp.sentinel.annotation.aspectj.integration.service.FooUtil;
...
import com.hellobikemap.csp.sentinel.util.MethodUtil;
...
public class SentinelAnnotationIntegrationTest extends AbstractJUnit4SpringContextTests {
    ...
    public void testClassLevelDefaultFallbackWithSingleParam() {
        ...
        String resourceName1 = "com.hellobikemap.csp.sentinel.annotation.aspectj.integration.service.BarService:doSomething(int)";
