...
**JAR 位置**: `sentinel-core/target/sentinel-core-1.8.6.map.2.RELEASE.jar`
...
**JAR 位置
**: `sentinel-cluster/sentinel-cluster-common-default/target/sentinel-cluster-common-default-1.8.6.map.2.RELEASE.jar`
...
**JAR 位置
**: `sentinel-cluster/sentinel-cluster-client-default/target/sentinel-cluster-client-default-1.8.6.map.2.RELEASE.jar`
...
```bash
$ jar tf sentinel-core-1.8.6.map.2.RELEASE.jar | grep ClusterMetadata
...
```bash
$ jar tf sentinel-cluster-client-default-1.8.6.map.2.RELEASE.jar | grep -E "TokenResult|MultiServer|ClusterClientMultiServer"
